...
export default function Modal({
  ...
  return (
    ...
    >
      <div
        id="modal-box"
        className="mx-auto flex w-3/4 max-w-sm -translate-y-1/2 flex-col gap-6 rounded-xl p-6 shadow-2xl bg-gray-800 text-gray-100"
      >
        <div>
        ...
        <div className="flex justify-center gap-8 px-5">
          <button
            className="w-20 rounded border py-2 font-medium transition hover:bg-black/10 border-gray-500 hover:border-gray-400"
